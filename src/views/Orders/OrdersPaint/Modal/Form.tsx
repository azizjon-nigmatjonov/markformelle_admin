...
export const OrderForm = ({
    ...
    const {
        ...
        getValues,
        reset
    } = useForm < any > ({mode: "onSubmit", resolver: yupResolver(schema)});
    ...
    return (
            ...
            <div className="border-b border-[var(--border)] pb-3 mb-3 grid grid-cols-3 gap-3">
                <div className="col-span-1 flex space-x-2">
                    <InputFieldUI title="SIPARISYILI">
                        <HFTextField name="SIPARISYILI"
                            control={control}
                            disabled={true}
                            defaultValue={
                                formData ?. SIPARISYILI
                            }
                            focused/>
                    </InputFieldUI>
                    <InputFieldUI title="BOYASIPARISKAYITID">
                        <HFTextField name="BOYASIPARISKAYITID"
                            control={control}
                            disabled={true}
                            defaultValue={
                                formData ?. BOYASIPARISKAYITID
                            }/>
                    </InputFieldUI>
                </div>
        ...
        <div className={`grid grid-cols-3 gap-x-3`}>
            <div className="space-y-2">
                <InputFieldUI title="FIRMA">
                    <LiteOptionsTable name="FIRMAID" staticSearchID="FIRMAID" link="firma"
                        required={true}
                        renderValue={
                            (_ : string, obj : any) => {
                                return obj ?. FIRMAID;
                        ...
                        defaultValue={
                            formData ?. FIRMAID && formData ?. FIRMAID + " - " + formData ?. FIRMAADI
                        }
                        headColumns={
                            [
                                {
        ...
        <InputFieldUI title="SIPARISGRUPADI">
            <HFTextField name="SIPARISGRUPADI"
                control={control}
                defaultValue={
                    formData ?. SIPARISGRUPADI
                }/>
        </InputFieldUI>
        <InputFieldUI title="sparis grubi">
            <LiteOptionsTable name="SIPARISGRUPID" link="siparisgrup"
                control={control}
                defaultValue={
                    formData ?. SIPARISGRUPID && formData ?. SIPARISGRUPADI ? formData ?. SIPARISGRUPID + " - " + formData ?. SIPARISGRUPADI : formData ?. SIPARISGRUPID
                }
                headColumns={
                    [
                        {
                ...
                renderValue={
                    (_ : string, obj : any) => {
                        return obj ?. SIPARISGRUPID && obj ?. ADI ? obj ?. SIPARISGRUPID + " - " + obj ?. ADI : obj ?. SIPARISGRUPID;
                    }
                }
                handleSelect={
                    (obj : any) => {
...
<InputFieldUI title="Sparis Veren">
    <HFTextField name="KULLANICIADI"
        control={control}
        defaultValue={
            formData ?. KULLANICIADI
        }/>
</InputFieldUI></div><div className="space-y-2">
<InputFieldUI title="islem tipi">
    <LiteOptionsTable name="ISLEMTIPIID" link="islemtipi"
        control={control}
        renderValue={
            (_ : string, obj : any) => {
                return obj ?. ISLEMTIPIID && obj ?. ADI ? obj ?. ISLEMTIPIID + " - " + obj ?. ADI : obj ?. ISLEMTIPIID;
            }
        }
...
</InputFieldUI><InputFieldUI title="Sparis alan"><HFTextField name="SIPARISIALANKULLANICIADI"
    control={control}
    defaultValue={
        formData ?. SIPARISIALANKULLANICIADI
    }/></InputFieldUI><InputFieldUI title="sparis sekli"><LiteOptionsTable name="ORMESIPARISSEKLIID" link="ormesiparissekli"
    control={control}
    renderValue={
        (_ : string, obj : any) => {
            return obj ?. ORMESIPARISSEKLIID && obj ?. ADI ? obj ?. ORMESIPARISSEKLIID + " - " + obj ?. ADI : obj ?. ORMESIPARISSEKLIID;
        }
    }
    defaultValue={
        formData ?. ORMESIPARISSEKLIID
    }
    headColumns={
        [
            {
    ...
    }/></InputFieldUI><InputFieldUI title="Sparis tipi"><LiteOptionsTable name="ORMESIPARISTIPIID" link="ormesiparistipi"
    control={control}
    headColumns={
        [
            {
    ...
    renderValue={
        (_ : string, obj : any) => {
            return obj ?. ORMESIPARISTIPIID && obj ?. ADI ? obj ?. ORMESIPARISTIPIID + " - " + obj ?. ADI : obj ?. ORMESIPARISTIPIID;
        }
    }
    defaultValue={
        formData ?. ORMESIPARISTIPIID
    }
    handleSelect={
        (obj : any) => {
            setValue("ORMESIPARISTIPIID", obj.ORMESIPARISTIPIID);
        }
    }/></InputFieldUI></div><div className="space-y-2"><InputFieldUI title="Notu" topPosition="items-start"><HFTextarea name="NOTU"
    control={control}
    minRows={4}
    defaultValue={
        formData ?. NOTU
    }/></InputFieldUI><InputFieldUI title="SIPARISTARIHI"><HFTextField name="SIPARISTARIHI"
    control={control}
    defaultValue={
        formData ?. SIPARISTARIHI
    }

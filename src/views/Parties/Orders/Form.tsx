      ...
      <div className="border-b border-[var(--border)] pb-3 mb-3 grid grid-cols-4 gap-x-3 gap-y-2">
        <div className="col-span-2 flex space-x-3">
          <InputFieldUI title="Parti">
            <LiteOptionsTable
              ...
              headColumns={[
                ...
                {
                  title: "Parti kayıt id",
                  id: "PARTIKAYITID",
                  width: 100,
                },
              ]}
              renderValue={(_: string, obj: any) => {
                return obj.PARTIADI && obj.PARTIKAYITID
                  ? `${obj.PARTIADI} - ${obj.PARTIKAYITID}`
                  : obj.PARTIKAYITID;
              }}
              control={control}
            />
          ...
          <InputFieldUI title="Parti id">
            <HFTextField name="PARTIID" control={control} disabled={true} />
          </InputFieldUI>
        </div>

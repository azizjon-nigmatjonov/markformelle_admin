            ...
            {machine.no_connnection != "true" && (
                <div className='flex flex-col justify-between h-full'>
                    ...
                    <div className={`w-full flex justify-center py-1 absolute top-[57%] left-1/2 -translate-x-1/2 -translate-y-1/2`}>
                        <CircularProgress strokeWidth={window.screen.width > 1400 ? 15 : window.screen.width < 1440 ? 12 : window.screen.width < 1280 ? 9 : 5} value={Number(machine.fakt_percentage) > 100
                            ? 100

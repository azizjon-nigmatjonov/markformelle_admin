    ...
    <>
      ...
      <div className="px-2 py-2 lg:p-3" ref={gridRef}>
        <div
          ...
          style={{ height: checked?.[0] !== 'all' || search.length ? 'auto' : window.screen.width < 940 ? 'auto' : openHeader ? 'calc(100vh - 75px)' : window.screen.width < 980 ? 'calc(100vh - 20px)' : 'calc(100vh - 25px)' }}

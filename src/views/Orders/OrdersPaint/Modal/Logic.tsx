...
export const FormLogic = () => {
    const setFormValues = (form : any, setValue : (name : string, value : any) => void) => {
    ...
    const setInitialFormValues = (setValue : (name : string, value : any) => void) => {
...
export const ModalTableLogic = ({setFormId, formId, defaultData, refetchTable} : {
...
export const OrderModalBaseLogics = ({defaultData, refetch} : {
    defaultData?: any;
    refetch: () => void;
}) => {
    ...
    const {createForm, updateForm, formData} = ModalTableLogic({formId: formId, defaultData, setFormId, refetchTable: refetch});
    ...
    const handleActionsTable = (obj : any, status : string, type : string) => {
        if (type === "material") {
            ...
            if (status.includes("yarn")) {
                ...
                if (status !== "view_single" || status.includes("view") || status.includes("edit")) {

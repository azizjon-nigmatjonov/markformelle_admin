...
export const breadCrumbs = [
  { label: "recete asama", link: "/lists/chemicals" },
];
...
export const TableData = ({
  ...
  const deleteFn = async (id: string[]) => {
    try {
      await axios.delete(`${API_URL}/receteasama/`, {
        method: "DELETE",
        url: `${API_URL}/receteasama/`,
        headers: {
